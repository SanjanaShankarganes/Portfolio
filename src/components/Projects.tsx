  ...
  return (
    <section id="projects" className="relative py-24 px-4 overflow-hidden" ref={ref}>
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Infinite Horizontal Carousel - Shows 3 cards at a time */}
        <div className="relative overflow-x-hidden py-8 -mx-4 px-4">
          <motion.div
          ...
          >
            {infiniteProjects.map((project, index) => (
              <motion.div
                ...
                className="flex-shrink-0 w-[calc(33.33%-1rem)] min-w-[300px] relative"
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-4">
                      <a
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg text-white transition-all hover:scale-105 font-semibold"
                      >
                        <FaGithub size={20} />
                        <span>Code</span>
                      </a>
